...
- One product represents one `companion`
...
- **Product Fields:**
  ...
  - `body_html`: Used as companion `description`
  - `images`: Profile images of the companion

#### Collections

- **Companion Collection**: collection_id `491355177275`
- Products under this collection are companions
