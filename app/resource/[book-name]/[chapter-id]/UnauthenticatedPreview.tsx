            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
              <div className="text-center lg:text-left">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">
                  {t(translations.resourcePage.moreContent)}
                </h3>
                <p className="text-gray-700 mb-4">
                  <span className="font-medium text-blue-600">
                    {t(translations.resourcePage.imagesRequireLogin).replace('{count}', String(images.length - 1))}
                  </span>
                </p>
                <p className="text-gray-600 mb-6">
                  {t(translations.resourcePage.loginToViewAll).replace('{count}', String(images.length))}
                </p>
                <Link
                ...
                >
                  ...
                  {t(translations.resourcePage.loginToViewComplete)}
                </Link>
              </div>
            </div>
          )}
        ...
        >
          ...
          >
            ...
            <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-black bg-opacity-50 text-white px-3 py-1 rounded-full text-sm">
              {t(translations.resourcePage.previewImage)}
            </div>
          </div>
        </div>
      )}
