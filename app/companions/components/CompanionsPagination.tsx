        ...
        {companions.map((companion, index) => (
          ...
          >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                    <div className="flex-1">
                      ...
                      <div className="prose prose-gray max-w-none">
                        <p className="text-gray-600 leading-relaxed">
                          {truncateText(extractTextFromHtml(companion.body_html), 280)}
                        </p>
                      </div>
                    ...
                    <div className="flex flex-col gap-3 md:ml-6">
                      ...
                      <button className="inline-flex items-center justify-center px-6 py-2 text-sm font-medium border-2 rounded-lg transition-colors hover:bg-gray-50"
            ...
            <div className="absolute top-4 left-4 md:relative md:top-0 md:left-0 md:hidden">
              <span className="inline-flex items-center justify-center w-8 h-8 text-sm font-bold text-white rounded-full" style={{backgroundColor: '#47709B'}}>
      ...
      {totalPages > 1 && (
        <div className="flex flex-col items-center space-y-4 border-t pt-8">
              ...
              {pageNumbers.map((page, index) => (
                page === '...' ? (
                  ...
                  <Link
                    ...
                    style={currentPage === page ? {backgroundColor: '#47709B'} : {}}
                  >
                    {page}
                  </Link>
                )
          ...
          <div className="text-sm text-gray-600 text-center">
            Showing {((currentPage - 1) * 8) + 1} to {Math.min(currentPage * 8, totalCompanions)} of {totalCompanions} companions
          </div>
